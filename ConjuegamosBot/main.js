...
async function start(text) {
    ...
    await page.goto("https://conjuguemos.com/auth/login/", {
      waitUntil: 'networkidle0',
    });
   await page.type("#identity",Settings['Username']);
   await page.type("#password",Settings['Password']);
   await page.type("#password","\n");
   await page.goto("https://conjuguemos.com/student/activities", {
    waitUntil: 'networkidle0',
  });
   ...
   await page.goto("https://conjuguemos.com/vocabulary/print_flashcards/" + aab, {
    waitUntil: 'networkidle0',
  })
   ...
   await page.goto("https://conjuguemos.com/vocabulary/homework/" + aab, {
    waitUntil: 'networkidle0',
  })
   var ab = await page.evaluate(() => {
    return document.getElementsByClassName("btn--start-gp btn")[0].id = "clickmedaddy"
   })
   await sleep(1000)
   ...
   var __loopIndex = 0;
   async function loop() {
    var ab2 = await page.evaluate(() => {
      return document.querySelector("#question-input").innerHTML
    })
    var ab3 = "";
    for (b of Vocab_List) {if (b[0]==ab2) {ab3=b[1]}}
    await page.type("#answer-input",ab3)
    await page.type("#answer-input","\n")
    var maxwanted_2 = (Settings['Max']!=null) ? Settings['Max'] : __loopIndex + 1
